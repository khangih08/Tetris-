...
void colorSelect(SDL_Renderer* gRenderer,const int& colorKey)
{
    ...
    {
        case 1:
            SDL_SetRenderDrawColor(gRenderer,3, 65, 174,SDL_ALPHA_OPAQUE);
        break;
        case 2:
            SDL_SetRenderDrawColor(gRenderer,114, 203, 59,SDL_ALPHA_OPAQUE);
        break;
        case 3:
            SDL_SetRenderDrawColor(gRenderer,255, 213, 0,SDL_ALPHA_OPAQUE);
        break;
        case 4:
            SDL_SetRenderDrawColor(gRenderer,255, 151, 28,SDL_ALPHA_OPAQUE);
        break;
        case 5:
            SDL_SetRenderDrawColor(gRenderer,255, 50, 19,SDL_ALPHA_OPAQUE);
        break;
        case 6:
            SDL_SetRenderDrawColor(gRenderer,140, 25, 255,SDL_ALPHA_OPAQUE);
        break;
